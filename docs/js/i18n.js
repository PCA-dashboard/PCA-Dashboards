...
(function (global) {
  ...
  var DICT = {
    zh: {
      ...
      "doc.title": "統一 Zip 格式與匯出器", "doc.subtitle": "Dashboard 與各匯出器之間的唯一契約",
      ...
      "bld.preview": "建立預覽 ▶", "bld.dlZip": "下載統一 Zip", "bld.package": "打包成 GitHub Pages 網站 ⬇",
    ...
    en: {
      ...
      "doc.title": "Unified Zip format & exporters", "doc.subtitle": "The single contract between the dashboard and every exporter",
      ...
      "bld.preview": "Build preview ▶", "bld.dlZip": "Download unified Zip", "bld.package": "Package as a GitHub Pages site ⬇",
